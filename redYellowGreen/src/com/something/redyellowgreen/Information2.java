...
public class Information2 extends SwarmActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = (Button) findViewById(R.id.infobutton2);
        button1.setOnClickListener(new View.OnClickListener() {
     	     public void onClick(View v) {
   	        	final Intent i = new Intent(Information2.this,Information3.class);
