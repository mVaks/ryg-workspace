...
public class Information3 extends SwarmActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = (Button) findViewById(R.id.infobutton3);
        button1.setOnClickListener(new View.OnClickListener() {
     	     public void onClick(View v) {
   	        	final Intent i = new Intent(Information3.this,Information4.class);
