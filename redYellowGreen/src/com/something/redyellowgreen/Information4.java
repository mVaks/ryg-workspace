...
public class Information4 extends SwarmActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = (Button) findViewById(R.id.infobutton4);
        button1.setOnClickListener(new View.OnClickListener() {
     	     public void onClick(View v) {
   	        	final Intent i = new Intent(Information4.this,Information5.class);
